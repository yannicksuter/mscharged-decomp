...
config.libs = [
    {
        ...
        "objects": [
            ...
            Object(Matching, "Game/FE/feCharacterPDAComponent.cpp", extra_cflags=["-inline auto", "-inline deferred", "-ipa file", "-sym on"]),
            ...
            Object(Matching, "Game/SH/SHChooseCaptains.cpp", extra_cflags=["-ipa file", "-sym on"]),
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(Matching, "RVL_SDK/hbm/nw4hbm/lyt/lyt_material.cpp", cflags=cflags_rvl_hbm),
