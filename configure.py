...
config.libs = [
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "RVL_SDK/bte/hcicmds.c", cflags=cflags_rvl_bte),
            ...
            Object(NonMatching, "RVL_SDK/bte/gki_time.c", cflags=cflags_rvl_bte),
            Object(NonMatching, "RVL_SDK/bte/hcisu_h2.c", cflags=cflags_rvl_bte),
            ...
            Object(NonMatching, "RVL_SDK/bte/bta_sys_main.c", cflags=cflags_rvl_bte),
            Object(NonMatching, "RVL_SDK/bte/bta_dm_act.c", cflags=cflags_rvl_bte),
            ...
            Object(NonMatching, "RVL_SDK/bte/bta_dm_pm.c", cflags=cflags_rvl_bte),
            ...
            Object(NonMatching, "RVL_SDK/bte/btm_acl.c", cflags=cflags_rvl_bte),
            Object(Matching, "RVL_SDK/bte/btm_dev.c", cflags=cflags_rvl_bte),
            Object(NonMatching, "RVL_SDK/bte/btm_devctl.c", cflags=cflags_rvl_bte),
            Object(NonMatching, "RVL_SDK/bte/btm_inq.c", cflags=cflags_rvl_bte),
            ...
            Object(NonMatching, "RVL_SDK/bte/gap_utils.c", cflags=cflags_rvl_bte),
            Object(NonMatching, "RVL_SDK/bte/hidd_pm.c", cflags=cflags_rvl_bte),
            ...
            Object(NonMatching, "RVL_SDK/bte/l2c_link.c", cflags=cflags_rvl_bte),
            Object(Matching, "RVL_SDK/bte/l2c_main.c", cflags=cflags_rvl_bte),
            Object(NonMatching, "RVL_SDK/bte/l2c_utils.c", cflags=cflags_rvl_bte),
            Object(Matching, "RVL_SDK/bte/port_rfc.c", cflags=cflags_rvl_bte),
            Object(NonMatching, "RVL_SDK/bte/port_utils.c", cflags=cflags_rvl_bte),
            Object(NonMatching, "RVL_SDK/bte/rfc_l2cap_if.c", cflags=cflags_rvl_bte),
            ...
            Object(NonMatching, "RVL_SDK/bte/sdp_api.c", cflags=cflags_rvl_bte),
            Object(NonMatching, "RVL_SDK/bte/sdp_db.c", cflags=cflags_rvl_bte),
            ...
            Object(NonMatching, "RVL_SDK/wud/WUD.c", cflags=cflags_rvl_wud),
            Object(NonMatching, "RVL_SDK/wud/WUDHidHost.c", cflags=cflags_rvl_wud),
