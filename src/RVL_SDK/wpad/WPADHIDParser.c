...
void (*__a1_input_reports_array[])(u8 chan, u8* data) = {
    __a1_20_status_report, __a1_21_user_data, __a1_22_ack, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_30_data_type, __a1_31_data_type, __a1_32_data_type, __a1_33_data_type, __a1_34_data_type, __a1_35_data_type, __a1_36_data_type, __a1_37_data_type, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_unused_report, __a1_3d_data_type, __a1_3e_data_type, __a1_3f_data_type
};
...
void abortInitExtension(s32 chan, s32 result)
{
    ...
    if (result != WPAD_ERR_OK)
    {
        ...
        {
            WPADiSendSetReportType(&p_wpd->extCmdQueue, p_wpd->dataFormat, NULL);
            return;
        }
...
void getDevConfig(s32 chan, s32 result, WPADStatus* p_status, u8* data)
{
    ...
    {
        p_status->obj[i].x = dummyObjX[i];
        p_status->obj[i].y = dummyObjY[i];
        p_status->obj[i].size = (u16)p_wpd->dpdDummyObjSize;
...
void getExtConfig(s32 chan, s32 result)
{
    ...
    if (p_wpd->devType == WPAD_DEV_FS || p_wpd->devType == WPAD_DEV_CLASSIC)
    {
        ...
        case WPAD_DEV_FS:
            ...
            else
            {
                ...
                DEBUGPrint("0G:  fsaccX = %d,  fsaccY = %d,  fsaccZ = %d\n", p_wpd->extConf.fs.acc_0g.x, p_wpd->extConf.fs.acc_0g.y, p_wpd->extConf.fs.acc_0g.z);
                DEBUGPrint("1G:  fsaccX = %d,  fsaccY = %d,  fsaccZ = %d\n", p_wpd->extConf.fs.acc_1g.x, p_wpd->extConf.fs.acc_1g.y, p_wpd->extConf.fs.acc_1g.z);
                DEBUGPrint("FS:  X = %d,  X max = %d,  X min = %d\n", p_wpd->extConf.fs.stick.x, p_wpd->extConf.fs.stick.x_max, p_wpd->extConf.fs.stick.x_min);
                DEBUGPrint("FS:  Y = %d,  Y max = %d,  Y min = %d\n", p_wpd->extConf.fs.stick.y, p_wpd->extConf.fs.stick.y_max, p_wpd->extConf.fs.stick.y_min);
            }
            break;
        ...
        case WPAD_DEV_CLASSIC:
            ...
            DEBUGPrint("CL:  X = %d,  X max = %d,  X min = %d\n", p_wpd->extConf.cl.lstk.x, p_wpd->extConf.cl.lstk.x_max, p_wpd->extConf.cl.lstk.x_min);
            DEBUGPrint("CL:  Y = %d,  Y max = %d,  Y min = %d\n", p_wpd->extConf.cl.lstk.y, p_wpd->extConf.cl.lstk.y_max, p_wpd->extConf.cl.lstk.y_min);
            DEBUGPrint("CR:  X = %d,  X max = %d,  X min = %d\n", p_wpd->extConf.cl.rstk.x, p_wpd->extConf.cl.rstk.x_max, p_wpd->extConf.cl.rstk.x_min);
            DEBUGPrint("CR:  Y = %d,  Y max = %d,  Y min = %d\n", p_wpd->extConf.cl.rstk.y, p_wpd->extConf.cl.rstk.y_max, p_wpd->extConf.cl.rstk.y_min);
...
void getExtType(s32 chan, s32 result)
{
    ...
    if (result == WPAD_ERR_OK)
    {
        _devMode[chan] = p_buf[0];

        switch (p_buf[1])
        {
        case 0x00:
            _devType[chan] = WPAD_DEV_FS;
            break;
        case 0x01:
        ...
        else
        {
            ...
            {
                WPADiSendWriteDataCmd(cmdq, 0xAA, WM_REG_EXTENSION_F0, abortInitExtension);
                WPADiCreateKey(chan);
...
static inline void initExtension(s32 chan)
{
    ...
    WPADiClearQueue(&p_wpd->extCmdQueue);
    WPADiSendSetReportType(&p_wpd->extCmdQueue, p_wpd->dataFormat, abortInitExtension);
    WPADiSendWriteDataCmd(&p_wpd->extCmdQueue, 0x55, WM_REG_EXTENSION_F0, abortInitExtension);
    WPADiSendWriteDataCmd(&p_wpd->extCmdQueue, extcmd, WM_REG_EXTENSION_FB, abortInitExtension);
    WPADiSendReadData(&p_wpd->extCmdQueue, p_wpd->wmReadDataBuf, 2, WM_REG_EXTENSION_DEV_MODE, abortInitExtension);
}
...
void __a1_20_status_report(u8 chan, u8* data)
{
    ...
    p_status->button = (u16)((u16)(((u16)((u16)(data[HID_IDX_BYTE7]) & 0xFF) | (u16)((u16)(data[HID_IDX_BYTE8] << 8) & 0xFF00))) & HID_WPAD_BUTTON_MASK);
...
void __a1_21_user_data(u8 chan, u8* data)
{
    ...
    if (addr >= base && addr <= base + p_wpd->wmReadLength)
    {
        ...
        if (base + p_wpd->wmReadLength == addr + len)
        {
            ...
            if ((p_wpd->wmReadAddr == 0 && p_wpd->oldFw == FALSE) || (p_wpd->wmReadAddr == WM_ADDR_MEM_176C && p_wpd->oldFw == TRUE))
            {
...
void __a1_22_ack(u8 chan, u8* data)
{
    ...
    p_status->button = (u16)((u16)(((u16)((u16)(data[HID_IDX_BYTE7]) & 0xFF) | (u16)((u16)(data[HID_IDX_BYTE8] << 8) & 0xFF00))) & (u16)HID_WPAD_BUTTON_MASK);
    ...
    if (fmt == WPAD_DPD_STANDARD)
    {
        for (i = 0; i < WPAD_DPD_MAX_OBJECTS; ++i)
        {
            if (i * 3 + 2 < len)
            {
                ...
                if ((*p_status)->obj[i].size == 0 || (*p_status)->obj[i].x == (s16)(WPAD_DPD_IMG_RESO_WX - 1) || (*p_status)->obj[i].y == (s16)(WPAD_DPD_IMG_RESO_WY - 1))
                {
...
void __a1_31_data_type(u8 chan, u8* data)
{
    ...
    p_status->dev = p_cb->devType;
    p_cb->info.nearempty = (u8)((data[HID_IDX_BYTE7] & HID_NEAREMPTY_MASK) >> 7);
    p_status->accX = (s16)((s16)((s16)((s16)((s16)data[HID_IDX_BYTE9] << 2) & (s16)0xFFFC) | (s16)((s16)(u16)(data[HID_IDX_BYTE7] >> 5) & (s16)0x0003)) - p_cb->devConf.acc_0g.x);
...
void __a1_32_data_type(u8 chan, u8* data)
{
    ...
    if (p_cb->info.attach)
    {
        if (p_cb->devType == WPAD_DEV_FS)
        {
            ...
            p_fsStat->fsAccX = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE11]) << 2) & (s16)0xFFFC) | (s16)((s16)(data[HID_IDX_BYTE14] >> 2) & (s16)(0x0003))) - p_cb->extConf.fs.acc_0g.x);
            p_fsStat->fsAccY = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE12]) << 2) & (s16)0xFFFC) | (s16)((s16)(data[HID_IDX_BYTE14] >> 4) & (s16)(0x0003))) - p_cb->extConf.fs.acc_0g.y);
            p_fsStat->fsAccZ = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE13]) << 2) & (s16)0xFFFC) | (s16)((s16)(data[HID_IDX_BYTE14] >> 6) & (s16)(0x0003))) - p_cb->extConf.fs.acc_0g.z);
        ...
        else if (p_cb->devType == WPAD_DEV_CLASSIC)
        {
            ...
            case 1:
                ...
                p_clStat->clTriggerL = (u8)((u8)((u8)((u8)(data[HID_IDX_BYTE11] >> 2) & (u8)0x18) | (u8)((u8)(data[HID_IDX_BYTE12] >> 5) & (u8)0x07)) << 3);
                p_clStat->clTriggerR = (u8)((u8)(data[HID_IDX_BYTE12] & (u8)0x1F) << 3);

                p_clStat->clButton = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE13]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE14]) & (u16)0xFF) ^ 0xFFFF);
                break;

            case 2:
                p_clStat = (WPADCLStatus*)&p_cb->rxBufs[p_cb->rxBufIndex];
                p_clStat->clLStickX = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE9]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE13])) & (s16)0x0003)) - (s16)(1024 / 2));
                p_clStat->clRStickX = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE10]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE13]) >> 2) & (s16)0x0003)) - (s16)(1024 / 2));
                p_clStat->clLStickY = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE11]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE13]) >> 4) & (s16)0x0003)) - (s16)(1024 / 2));
                p_clStat->clRStickY = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE12]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE13]) >> 6) & (s16)0x0003)) - (s16)(1024 / 2));
                p_clStat->clTriggerL = (u8)(data[HID_IDX_BYTE14]);
                p_clStat->clTriggerR = (u8)(data[HID_IDX_BYTE15]);

                p_clStat->clButton = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE16]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE17]) & (u16)0xFF) ^ 0xFFFF);
                break;
            ...
            case 3:
                ...
                p_clStat->clButton = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE15]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE16]) & (u16)0xFF) ^ 0xFFFF);
                break;
            }
...
void __a1_33_data_type(u8 chan, u8* data)
{
    ...
    p_status->dev = p_cb->devType;
    p_cb->info.nearempty = (u8)((data[HID_IDX_BYTE7] & HID_NEAREMPTY_MASK) >> 7);
    p_status->accX = (s16)((s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE9]) << 2) & (s16)0xFFFC) | (s16)((s16)((u16)(data[HID_IDX_BYTE7] >> 5)) & (s16)0x0003))) - (s16)(p_cb->devConf.acc_0g.x));
...
void __a1_35_data_type(u8 chan, u8* data)
{
    ...
    if (p_cb->info.attach)
    {
        if (p_cb->devType == WPAD_DEV_FS)
        {
            ...
            p_fsStat->fsAccX = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE14]) << 2) & (s16)0xFFFC) | (s16)((s16)(data[HID_IDX_BYTE17] >> 2) & (s16)(0x0003))) - (s16)(p_cb->extConf.fs.acc_0g.x));
            p_fsStat->fsAccY = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE15]) << 2) & (s16)0xFFFC) | (s16)((s16)(data[HID_IDX_BYTE17] >> 4) & (s16)(0x0003))) - (s16)(p_cb->extConf.fs.acc_0g.y));
            p_fsStat->fsAccZ = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE16]) << 2) & (s16)0xFFFC) | (s16)((s16)(data[HID_IDX_BYTE17] >> 6) & (s16)(0x0003))) - (s16)(p_cb->extConf.fs.acc_0g.z));
        ...
        else if (p_cb->devType == WPAD_DEV_CLASSIC)
        {
            ...
            case 1:
                ...
                p_clStat->clRStickX = (s16)((s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE12]) >> 3) & (s16)0x0018) | (s16)((s16)((s16)(data[HID_IDX_BYTE13]) >> 5) & (s16)0x0006) | (s16)((s16)((s16)(data[HID_IDX_BYTE14]) >> 7) & (s16)0x0001))
                                                  << 5)
                                            - (s16)(1024 / 2));
                p_clStat->clRStickY = (s16)((s16)((s16)((s16)(data[HID_IDX_BYTE14]) & (s16)0x001F) << 5) - (s16)(1024 / 2));
                p_clStat->clTriggerL = (u8)((u8)((u8)((u8)(data[HID_IDX_BYTE14] >> 2) & (u8)0x18) | (u8)((u8)(data[HID_IDX_BYTE15] >> 5) & (u8)0x07)) << 3);
            ...
            case 2:
                p_clStat = (WPADCLStatus*)&p_cb->rxBufs[p_cb->rxBufIndex];
                p_clStat->clLStickX = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE12]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE16])) & (s16)0x0003)) - (s16)(1024 / 2));
                p_clStat->clRStickX = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE13]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE16]) >> 2) & (s16)0x0003)) - (s16)(1024 / 2));
                p_clStat->clLStickY = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE14]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE16]) >> 4) & (s16)0x0003)) - (s16)(1024 / 2));
                p_clStat->clRStickY = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE15]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE16]) >> 6) & (s16)0x0003)) - (s16)(1024 / 2));
                p_clStat->clTriggerL = (u8)(data[HID_IDX_BYTE17]);
                p_clStat->clTriggerR = (u8)(data[HID_IDX_BYTE18]);

                p_clStat->clButton = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE19]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE20]) & (u16)0xFF) ^ 0xFFFF);
                break;
            ...
            case 3:
                ...
                p_clStat->clButton = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE18]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE19]) & (u16)0xFF) ^ 0xFFFF);
                break;
            }
...
void __a1_37_data_type(u8 chan, u8* data)
{
    ...
    p_status->dev = p_cb->devType;
    p_cb->info.nearempty = (u8)((data[HID_IDX_BYTE7] & HID_NEAREMPTY_MASK) >> 7);
    p_status->accX = (s16)((s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE9]) << 2) & (s16)0xFFFC) | (s16)((s16)((u16)(data[HID_IDX_BYTE7] >> 5)) & (s16)0x0003))) - p_cb->devConf.acc_0g.x);
    p_status->accY = (s16)((s16)((s16)((s16)((s16)data[HID_IDX_BYTE10] << 2) & (s16)0xFFFC) | (s16)((s16)(u16)(data[HID_IDX_BYTE8] >> 4) & (s16)0x0002)) - p_cb->devConf.acc_0g.y);
    p_status->accZ = (s16)((s16)((s16)((s16)((s16)data[HID_IDX_BYTE11] << 2) & (s16)0xFFFC) | (s16)((s16)(u16)(data[HID_IDX_BYTE8] >> 5) & (s16)0x0002)) - p_cb->devConf.acc_0g.z);
    ...
    if (p_cb->info.attach)
    {
        if (p_cb->devType == WPAD_DEV_FS)
        {
            ...
            p_fsStat->fsAccX = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE24]) << 2) & (s16)0xFFFC) | (s16)((s16)(data[HID_IDX_BYTE27] >> 2) & (s16)(0x0003))) - p_cb->extConf.fs.acc_0g.x);
            p_fsStat->fsAccY = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE25]) << 2) & (s16)0xFFFC) | (s16)((s16)(data[HID_IDX_BYTE27] >> 4) & (s16)(0x0003))) - p_cb->extConf.fs.acc_0g.y);
            p_fsStat->fsAccZ = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE26]) << 2) & (s16)0xFFFC) | (s16)((s16)(data[HID_IDX_BYTE27] >> 6) & (s16)(0x0003))) - p_cb->extConf.fs.acc_0g.z);
        ...
        else if (p_cb->devType == WPAD_DEV_CLASSIC)
        {
            ...
            case 1:
                ...
                p_clStat->clRStickX = (s16)((s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE22]) >> 3) & (s16)0x0018) | (s16)((s16)((s16)(data[HID_IDX_BYTE23]) >> 5) & (s16)0x0006) | (s16)((s16)((s16)(data[HID_IDX_BYTE24]) >> 7) & (s16)0x0001))
                                                  << 5)
                                            - (s16)(1024 / 2));
                p_clStat->clRStickY = (s16)((s16)((s16)((s16)(data[HID_IDX_BYTE24]) & (s16)0x001F) << 5) - (s16)(1024 / 2));
                p_clStat->clTriggerL = (u8)((u8)((u8)((u8)(data[HID_IDX_BYTE24] >> 2) & (u8)0x18) | (u8)((u8)(data[HID_IDX_BYTE25] >> 5) & (u8)0x07)) << 3);
                p_clStat->clTriggerR = (u8)((u8)((u8)(data[HID_IDX_BYTE25]) & (u8)0x1F) << 3);

                p_clStat->clButton = (u16)((u16)((u16)((u16)(data[HID_IDX_BYTE26]) << 8) & (u16)0xFF00 | (u16)(data[HID_IDX_BYTE27]) & (u16)0xFF) ^ 0xFFFF);
                break;

            case 2:
                p_clStat = (WPADCLStatus*)&p_cb->rxBufs[p_cb->rxBufIndex];
                p_clStat->clLStickX = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE22]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE26])) & (s16)0x0003)) - (s16)(1024 / 2));
                p_clStat->clRStickX = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE23]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE26]) >> 2) & (s16)0x0003)) - (s16)(1024 / 2));
                p_clStat->clLStickY = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE24]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE26]) >> 4) & (s16)0x0003)) - (s16)(1024 / 2));
                p_clStat->clRStickY = (s16)((s16)((s16)((s16)((s16)(data[HID_IDX_BYTE25]) << 2) & (s16)0xFFFC) | (s16)((s16)((s16)(data[HID_IDX_BYTE26]) >> 6) & (s16)0x0003)) - (s16)(1024 / 2));
...
void __a1_3e_data_type(u8 chan, u8* data)
{
    ...
    p_status->accX = (s16)((s16)((s16)((s16)((s16)data[HID_IDX_BYTE9] << 2) & (s16)0xFFFC) | (s16)((s16)(u16)(data[HID_IDX_BYTE7] >> 6) & (s16)0x0002)) - p_cb->devConf.acc_0g.x);
    p_status->accZ |= (s16)((s16)((s16)((s16)data[HID_IDX_BYTE8] << 3) & (s16)0xFF00) | (s16)((s16)(u16)(data[HID_IDX_BYTE7] << 1) & (s16)0x00C0));

    p_status->obj[0].x = (s16)((s16)((u16)data[HID_IDX_BYTE10] & 0xFF) | (u16)((u16)(data[HID_IDX_BYTE12] & 0x30) << 4));
    p_status->obj[0].y = (s16)(WPAD_DPD_IMG_RESO_WY - 1 - (s16)((s16)(((u16)(data[HID_IDX_BYTE11])) & 0xFF) | (u16)(((u16)(data[HID_IDX_BYTE12] & 0xC0)) << 2)));
    ...
    if (p_status->obj[0].size == 0 || p_status->obj[0].x == (s16)(WPAD_DPD_IMG_RESO_WX - 1) || p_status->obj[0].y == (s16)(WPAD_DPD_IMG_RESO_WY - 1) || p_status->exp[0].radius == 0xf)
    {
    ...
    p_status->obj[1].x = (s16)((s16)((u16)data[HID_IDX_BYTE19] & 0xFF) | (u16)((u16)(data[HID_IDX_BYTE21] & 0x30) << 4));
    p_status->obj[1].y = (s16)(WPAD_DPD_IMG_RESO_WY - 1 - (s16)((s16)(((u16)(data[HID_IDX_BYTE20])) & 0xFF) | (u16)(((u16)(data[HID_IDX_BYTE21] & 0xC0)) << 2)));
    ...
    if (p_status->obj[1].size == 0 || p_status->obj[1].x == (s16)(WPAD_DPD_IMG_RESO_WX - 1) || p_status->obj[1].y == (s16)(WPAD_DPD_IMG_RESO_WY - 1) || p_status->exp[1].radius == 0xf)
    {
    ...
    {
        p_status->accZ -= (s16)(p_cb->devConf.acc_0g.z);
        p_cb->rxBufIndex = (u8)((p_cb->rxBufIndex) ? 0 : 1);
...
void __a1_3f_data_type(u8 chan, u8* data)
{
    ...
    p_status->dev = p_cb->devType;
    p_cb->info.nearempty = 0;
    p_status->accY = (s16)((s16)((s16)((s16)((s16)data[HID_IDX_BYTE9] << 2) & (s16)0xFFFC) | (s16)((s16)(u16)(data[HID_IDX_BYTE7] >> 6) & (s16)0x0002)) - p_cb->devConf.acc_0g.y);
    p_status->accZ |= (s16)((s16)((s16)((s16)data[HID_IDX_BYTE8] >> 1) & (s16)0x0030) | (s16)((s16)(u16)(data[HID_IDX_BYTE7] >> 3) & (s16)0x000C));

    p_status->obj[2].x = (s16)((s16)((u16)data[HID_IDX_BYTE10] & 0xFF) | (u16)((u16)(data[HID_IDX_BYTE12] & 0x30) << 4));
    p_status->obj[2].y = (s16)(WPAD_DPD_IMG_RESO_WY - 1 - (s16)((s16)(((u16)(data[HID_IDX_BYTE11])) & 0xFF) | (u16)(((u16)(data[HID_IDX_BYTE12] & 0xC0)) << 2)));
    ...
    if (p_status->obj[2].size == 0 || p_status->obj[2].x == (s16)(WPAD_DPD_IMG_RESO_WX - 1) || p_status->obj[2].y == (s16)(WPAD_DPD_IMG_RESO_WY - 1) || p_status->exp[2].radius == 0xf)
    {
    ...
    p_status->obj[3].x = (s16)((s16)((u16)data[HID_IDX_BYTE19] & 0xFF) | (u16)((u16)(data[HID_IDX_BYTE21] & 0x30) << 4));
    p_status->obj[3].y = (s16)(WPAD_DPD_IMG_RESO_WY - 1 - (s16)((s16)(((u16)(data[HID_IDX_BYTE20])) & 0xFF) | (u16)(((u16)(data[HID_IDX_BYTE21] & 0xC0)) << 2)));
    ...
    if (p_status->obj[3].size == 0 || p_status->obj[3].x == (s16)(WPAD_DPD_IMG_RESO_WX - 1) || p_status->obj[3].y == (s16)(WPAD_DPD_IMG_RESO_WY - 1) || p_status->exp[3].radius == 0xf)
    {
    ...
    if (_recv_3e[chan] && _recv_3f[chan])
    {
        p_status->accZ -= p_cb->devConf.acc_0g.z;
        p_cb->rxBufIndex = (u8)((p_cb->rxBufIndex) ? 0 : 1);
        _recv_3e[chan] = _recv_3f[chan] = 0;
    }
    OSRestoreInterrupts(old);
