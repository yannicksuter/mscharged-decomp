...
const char* __THPVersion = "<< RVL_SDK - THP \trelease build: Nov 30 2006 03:09:42 (0x4199_60831) >>";
...
#define ROUNDUP_DIV(a, b) ((((s32)(a)) + ((s32)(b) - 1L)) / ((s32)(b)))
...
u8 __THPReadScaneHeader(void) {
    ...
    __THPInfo->c += 3;
    __THPInfo->MCUsPerRow = (u16)ROUNDUP_DIV(__THPInfo->xPixelSize, 16);
