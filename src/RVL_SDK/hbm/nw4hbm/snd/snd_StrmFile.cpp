...
bool StrmFileReader::IsValidFileHeader(const void* strmData)
{
    ...
    NW4HBMAssertMessage_Line(fileHeader->version >= NW4HBM_VERSION(1, 0), 57, "strm file is not supported version.\n  please reconvert file using new version tools.\n");
    if (fileHeader->version < NW4HBM_VERSION(1, 0))
    {
        return false;
    }

    NW4HBMAssertMessage_Line(fileHeader->version <= StrmFile::FILE_VERSION, 63, "strm file is not supported version.\n  please reconvert file using new version tools.\n");
