            ...
            signed_int:
                ...
                if (match_failure) {
                    ...
                    if ((format.argument_options == long_long_argument) ||
                        ...
                        u_long_long_num = __strtoull(base, format.field_width, ReadProc, ReadProcArg, &num_chars,
                                                     &negative, &overflow);
                    } else {
                        u_long_num = __strtoul(base, format.field_width, ReadProc, ReadProcArg, &num_chars, &negative,
                                               &overflow);
                    }
