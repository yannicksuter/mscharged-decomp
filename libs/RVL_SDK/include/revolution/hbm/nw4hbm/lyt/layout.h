...
public:
    ...
    /* 0x10 */ virtual AnimTransform* CreateAnimTransform(const void* anmResBuf, ResourceAccessor* pResAcsr);
    ...
    /* 0x20 */ virtual void SetAnimationEnable(AnimTransform* animTrans, bool bEnable = true);
